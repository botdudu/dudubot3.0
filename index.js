		...
		try {
			...
			mess = {
				...
				only: {
					...
					admin: '❌ Este comando só pode ser usado pelo grupo de administração! ❌',
					Badmin: '❌ Este comando só pode ser usado quando o bot se torna administrador! ❌'
				}
			}

			const botNumber = client.user.jid
			const ownerNumber = ["31986283462@s.whatsapp.net"] // substitua pelo seu número
			...
			switch(command) {
				...
				case 'tagall':
					...
					break
				case 'clearall':
					if (!isOwner) return reply('Kamu siap?')
